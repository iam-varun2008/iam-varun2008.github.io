 ...
 * Each segment contains walls, profile text, doors and decorations.
 * 
        ...
        <group position={[0, 0, 0]}>
            ...
            <group position={[0, 0, zOffset - 2]}>
                ...
                <Text
                    ...
                    font="/fonts/CabinSketch-Bold.ttf"
                >
                    {`${PROFILE.location}  •  Grade 12: ${PROFILE.marks[2].score}`}
                </Text>
            ...
            {!hideSegmentDoors && segmentIndex === 0 && (
                <DoorSection
                    position={[0, 0, zOffset - SEGMENT_LENGTH + 0.02]}
                    side="left"
                    label="CONTACT"
                    roomId="contact"
                    icon="✉"
                    onEnter={() => onDoorEnter?.('contact')}
                    setCameraOverride={setCameraOverride}
                    segmentIndex={segmentIndex}
                    isEndDoor
                />
