...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'VARUN', subtitle: '< cybersecurity • Python • security tools • graphite art />' },
    { id: 'focus', position: [0, 0, -55], type: 'awards', title: 'PROFILE', subtitle: 'Academic results • Security projects • Certifications' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'Learning computer science through practical projects' },
    { id: 'skills', position: [0, 0, -135], type: 'skills', title: 'SKILLS', subtitle: 'Python • Git • GitHub • Linux • Networking' },
];
