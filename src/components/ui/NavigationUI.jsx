...
const ROOMS = [
    ...
    { id: 'contact', label: 'Contact', x: 50, y: 9 },   // Final centered door
    { id: 'studio', label: 'Arts', x: 57, y: 55 },    // Drawing archive (right side)
];
                    ...
                    <div className="map-content-clipped">
                        ...
                        <div className="map-container">
                            ...
                            <button
                                ...
                                aria-label="Teleport to Projects room"
                            />
                            <button
                                type="button"
                            ...
                            <button
                                ...
                                aria-label="Teleport to Arts room"
                            />

                            {/* Permanent Map Text Labels */}
                            <div className="map-room-label about">ABOUT</div>
                            <div className="map-room-label gallery">PROJECTS</div>
                            <div className="map-room-label contact">CONTACT</div>
                            <div className="map-room-label studio">ARTS</div>
