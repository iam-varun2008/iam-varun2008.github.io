  ...
  useEffect(() => {
    ...
    gsap.to(trackerRef.current, {
      ...
      onUpdate: () => {
        ...
        else if (safeProgress < 50) statusMsg = "Loading Cybersecurity Projects...";
        else if (safeProgress < 70) statusMsg = "Parsing Security Tools...";
        else if (safeProgress < 85) statusMsg = "Verifying Academic Highlights...";
        else if (safeProgress < 95) statusMsg = "Preparing Skills & Certificates...";
