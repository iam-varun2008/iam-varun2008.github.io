...
const useInfiniteCamera = ({
    ...
    const handleWheel = useCallback((e) => {
        ...
        targetZ.current = Math.max(minZ, targetZ.current - delta);
        unlockAchievement('corridor_explore');
    }, [scrollSpeed, minZ, unlockAchievement]);
    ...
    const handleKeyDown = useCallback((e) => {
        ...
        if (delta !== undefined) {
            e.preventDefault();
            targetZ.current = Math.max(minZ, targetZ.current - delta * scrollSpeed);
            unlockAchievement('corridor_explore');
        }
    ...
    }, [scrollSpeed, minZ, MAX_SWIPE_GLANCE, unlockAchievement]);
    ...
    const handleTouchMove = useCallback((e) => {
        ...
        if (scrollEnabledRef.current) {
            ...
            targetZ.current = Math.max(minZ, targetZ.current - deltaY);
            unlockAchievement('corridor_explore');
        }
    ...
    }, [scrollSpeed, minZ, MAX_SWIPE_GLANCE]);
